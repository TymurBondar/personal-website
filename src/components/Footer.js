...
export default function Footer() {
  return (
    <footer className="flex p-2 md:p-4 items-center bg-bark-950 text-cream-100">
      <nav className="flex w-full px-1">
        ...
        <Link href="https://www.linkedin.com/in/tymurbondar/" target="_blank" className="flex-shrink-0 text-cream-100">
          <svg
        ...
        <Link className="mx-3 flex-shrink-0 text-cream-100" href="https://t.me/BondarTymur" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={24}
            height={24}
